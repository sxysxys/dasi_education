...
/**
 * @Author: shenge
 * @Date: 2020-05-14 11:01
 * <p>
 * 阿里云视频测试
 */
@SpringBootTest
public class AliyunVideoUploadTest {
    ...
    public void uploadVideo() {
        ...
        //文件名必须包含扩展名
        String fileName = "/Users/sxy/111.mp4";
        //本地文件上传
        testUploadVideo(KeyAndSecret.KEY_ID, KeyAndSecret.KEY_SECRET, title, fileName);
        //2.图片上传-本地文件上传
//        testUploadImageLocalFile(ConstantPropertiesUtils.KEY_ID, ConstantPropertiesUtils.KEY_SECRET);
    }
